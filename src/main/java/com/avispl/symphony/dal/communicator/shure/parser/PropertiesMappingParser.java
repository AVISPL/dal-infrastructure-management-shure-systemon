    ...
    public Map<String, PropertiesMapping> load() {
        PropertiesMapping mxa310Mapping = new PropertiesMapping(
                ImmutableMap.<String, String>builder()
                        ...
                        .put("EnableLowCutFilter", "EnableLowCutFilter")
                        .put("PasswordSet", "PasswordSet")
                        .put("Mute", "DeviceAudioMute")
                        .put("ActivePresetIndex", "ActivePresetIndex")
                        .put("DeviceVersion", "DeviceVersion")
                        .put("Encryption", "EncryptionEnabled")
                        .put("EncryptionPassphraseSet", "EncryptionPassphraseSet")
                        .put("IpMode", "IpMode")
                        .put("IpAddress", "IpAddress")
                        .put("SubnetMask", "SubnetMask")
                        .put("DefaultGateway", "DefaultGateway")
                        .put("Reboot", "Reboot")
                        .put("Reset", "Reset")
                        .build(),
                ImmutableMap.<String, String>builder()
                        .put("DeviceNameConflict", "DeviceNameConflict")
                        .put("ClockSyncError", "ClockSyncError")
                        .put("Uptime", "Uptime")
                        .build(),
                ImmutableMap.<String, String>builder()
